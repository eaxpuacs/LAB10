...
public:
    ...
    static void actualizaMiembro(string nombreBuscar, int nuevaEdad, string nuevoCorreo) {
        ifstream archivo("club.txt");
...
int main() {
    ...
    do {
        ...
        if (opcion == 1) {
            ...
            cin >> correo;
            MiembroClub::actualizaMiembro(nombre, edad, correo);
        }
        else if (opcion == 4) {
            string nombre;
